...
@nb.njit
def solve_hh_backwards(par,z_trans,w,delta,lambda_u_s,tau,UI_ratio_high,UI_duration,
    ...
    for i_fix in range(par.Nfix):
        for i_z in range(par.Nz):
            ...
            if i_z == 0:
                ...
                y = (u_UI_*UI_ratio_high + (1-u_UI_)*par.UI_ratio_low)*w*(1)
                u_pol[i_fix,i_z,:] = 1
            ...
            if par.beta_grid[i_fix] < par.beta_HtM: # HtM
                ...
                V[i_fix,i_z,:] = c[i_fix,i_z]**(1.0-par.sigma) / (1.0-par.sigma) + par.beta_grid[i_fix]*vbeg_plus_interp
           
            # iii. envelope
            v_a[i_fix,i_z] = c[i_fix,i_z]**(-par.sigma)            
