...
class HANKSAMModelClass(EconModelClass,GEModelClass):    
    ...
    def settings(self):
        ...
        self.grids_hh = ['a']
        self.pols_hh = ['a','s','V']
        self.inputs_hh = ['w','delta','lambda_u_s','tau','UI_ratio_high','UI_duration']
        ...
        # c. GE
        self.shocks = []
        self.unknowns = ['vt','ut','S','guess_U_UI']
    ...
    def set_macros(self,free_entry=None,wage_setting=None):
        ...
        # baseline
        unknowns = ['px','Vj','Vv','ut','vt','U_UI_hh_guess']
        ...
        # a. free entry
        if par.free_entry:
            unknowns = ['px','entry','Vj','ut','vt','U_UI_hh_guess']
